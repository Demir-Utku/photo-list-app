...
export default class Header extends Component {
    ...
    return (
      <div
        className={`search-form ${
          this.props.inline ? this.props.inline + "-search-form" : ""
        }`}
      >
        {/* Query text input */}
        <input
          className={`input input-query ${
            this.props.inline ? this.props.inline + "-input-query" : ""
          }`}
          type="text"
          name="query"
        ...
        <div
          className={`select-wrapper ${
            this.props.inline ? this.props.inline + "-select-wrapper" : ""
          }`}
        >
          {
            <List
        ...
        <button
          className={`input search-button ${
            this.props.inline ? this.props.inline + "-search-button" : ""
          }`}
  ...
  render() {
    ...
    return (
      <header
        className={`header ${
          this.props.inline ? this.props.inline + "-header" : ""
        }`}
      >
        <div
          className={`header-logo-wrapper ${
            this.props.inline ? this.props.inline + "-header-logo-wrapper" : ""
          }`}
        >
          <div
            className={`header-logo ${
              this.props.inline ? this.props.inline + "-header-logo" : ""
            }`}
          >
            <img
              className={`logo ${
                this.props.inline ? this.props.inline + "-logo" : ""
              }`}
              src={Logo}
              alt="logo"
            />
          ...
          <h1
            className={`header-logo-name ${
              this.props.inline ? this.props.inline + "-header-logo-name" : ""
            }`}
          >
            <b>image</b> search
          </h1>
